...
class CloudConnect {
	...
	/* Invoke will execute an AWS lambda function */
	...
	login (username, password) {
		...
		return this.loadManifest()
			...
			/* Get basic AWS credentials with Cloud Connect Identity poool */ 
			...
			.then(account => {
				...
				/* Store Cloud Connect account data and session tokens,
				 * especially refreshToken used when the session token
				 * has expired.
				 */
