...
#define MQTT_PUB_TOPIC "$aws/things/00000205/shadow/update"
#define MQTT_SUB_TOPIC "$aws/things/00000205/shadow/update/#"
#define MQTT_MSG "{\"state\":{\"reported\":{\"latlng\":\"69.6527,18.9291\",\"string_value\":\"ESP8266\"}}}"
#define MQTT_CLIENTID "00000205"
#define GPIO_LED 2
    ...
    while (1) {
        ...
        while (wifi_alive && !ssl_reset) {
            ...
            while (xQueueReceive(publish_queue, (void *) msg, 0) == pdTRUE) {
                snprintf(msg, sizeof(msg), MQTT_MSG);
                printf("Publishing: %s\r\n", msg);
